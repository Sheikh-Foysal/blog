                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                    ...
                                    <div class="form-group">
                                        <input type="checkbox" name="status" id="publish" class="filled-ind" {{ $post->status == true ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line {{ $errors->has('categories') ? 'focused' : '' }}">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line {{ $errors->has('tags') ? 'focused' : '' }}">
                                            <label class="tag">Tags name</label>
